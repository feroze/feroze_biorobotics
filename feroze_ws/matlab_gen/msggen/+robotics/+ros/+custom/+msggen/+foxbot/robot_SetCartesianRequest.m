classdef robot_SetCartesianRequest < robotics.ros.Message
    %robot_SetCartesianRequest MATLAB implementation of foxbot/robot_SetCartesianRequest
    ...
    properties (Constant)
        MessageType = 'foxbot/robot_SetCartesianRequest' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = '9cd50f3d494a20bbfd742759ec33572a' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Hidden)
        PropertyList = {'FrameId', 'Q0', 'Qx', 'Qy', 'Qz', 'X', 'Y', 'Z'} % List of non-constant message properties
        ROSPropertyList = {'frameId', 'q0', 'qx', 'qy', 'qz', 'x', 'y', 'z'} % List of non-constant ROS message properties
    end
    ...
    methods
        ...
        function set.FrameId(obj, frameid)
            ...
            validateattributes(frameid, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetCartesianRequest', 'frameid');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.foxbot.robot_SetCartesianRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.foxbot.robot_SetCartesianRequest;
            obj.reload(strObj);
        end
    end
end
