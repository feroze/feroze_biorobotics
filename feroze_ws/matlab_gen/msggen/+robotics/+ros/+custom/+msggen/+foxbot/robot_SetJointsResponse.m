classdef robot_SetJointsResponse < robotics.ros.Message
    %robot_SetJointsResponse MATLAB implementation of foxbot/robot_SetJointsResponse
    ...
    properties (Constant)
        MessageType = 'foxbot/robot_SetJointsResponse' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.foxbot.robot_SetJointsResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.foxbot.robot_SetJointsResponse;
            obj.reload(strObj);
        end
    end
end
