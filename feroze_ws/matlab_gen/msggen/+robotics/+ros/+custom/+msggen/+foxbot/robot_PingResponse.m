classdef robot_PingResponse < robotics.ros.Message
    %robot_PingResponse MATLAB implementation of foxbot/robot_PingResponse
    ...
    properties (Constant)
        MessageType = 'foxbot/robot_PingResponse' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.foxbot.robot_PingResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.foxbot.robot_PingResponse;
            obj.reload(strObj);
        end
    end
end
