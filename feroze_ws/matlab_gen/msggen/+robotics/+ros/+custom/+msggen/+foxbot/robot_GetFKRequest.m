classdef robot_GetFKRequest < robotics.ros.Message
    %robot_GetFKRequest MATLAB implementation of foxbot/robot_GetFKRequest
    ...
    properties (Constant)
        MessageType = 'foxbot/robot_GetFKRequest' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.foxbot.robot_GetFKRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.foxbot.robot_GetFKRequest;
            obj.reload(strObj);
        end
    end
end
