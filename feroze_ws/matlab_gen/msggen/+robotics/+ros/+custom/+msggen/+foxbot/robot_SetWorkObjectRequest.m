classdef robot_SetWorkObjectRequest < robotics.ros.Message
    %robot_SetWorkObjectRequest MATLAB implementation of foxbot/robot_SetWorkObjectRequest
    ...
    properties (Constant)
        MessageType = 'foxbot/robot_SetWorkObjectRequest' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.foxbot.robot_SetWorkObjectRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.foxbot.robot_SetWorkObjectRequest;
            obj.reload(strObj);
        end
    end
end
