classdef robot_SetTrackingResponse < robotics.ros.Message
    %robot_SetTrackingResponse MATLAB implementation of foxbot/robot_SetTrackingResponse
    ...
    properties (Constant)
        MessageType = 'foxbot/robot_SetTrackingResponse' % The ROS message type
    end
    ...
    methods
        function obj = robot_SetTrackingResponse(msg)
            %robot_SetTrackingResponse Construct the message object robot_SetTrackingResponse
        ...
        function set.Ret(obj, ret)
            ...
            validateattributes(ret, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetTrackingResponse', 'ret');
        ...
        function set.Msg(obj, msg)
            ...
            validateattributes(msg, {'char'}, {}, 'robot_SetTrackingResponse', 'msg');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.foxbot.robot_SetTrackingResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.foxbot.robot_SetTrackingResponse;
            obj.reload(strObj);
        end
    end
end
