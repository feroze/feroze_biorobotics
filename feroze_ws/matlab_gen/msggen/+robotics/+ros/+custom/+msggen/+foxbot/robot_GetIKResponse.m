classdef robot_GetIKResponse < robotics.ros.Message
    %robot_GetIKResponse MATLAB implementation of foxbot/robot_GetIKResponse
    ...
    properties (Constant)
        MessageType = 'foxbot/robot_GetIKResponse' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.foxbot.robot_GetIKResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.foxbot.robot_GetIKResponse;
            obj.reload(strObj);
        end
    end
end
