classdef robot_SetDefaultsResponse < robotics.ros.Message
    %robot_SetDefaultsResponse MATLAB implementation of foxbot/robot_SetDefaultsResponse
    ...
    properties (Constant)
        MessageType = 'foxbot/robot_SetDefaultsResponse' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.foxbot.robot_SetDefaultsResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.foxbot.robot_SetDefaultsResponse;
            obj.reload(strObj);
        end
    end
end
