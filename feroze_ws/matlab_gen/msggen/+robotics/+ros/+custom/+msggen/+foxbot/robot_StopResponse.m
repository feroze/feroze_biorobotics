classdef robot_StopResponse < robotics.ros.Message
    %robot_StopResponse MATLAB implementation of foxbot/robot_StopResponse
    ...
    properties (Constant)
        MessageType = 'foxbot/robot_StopResponse' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.foxbot.robot_StopResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.foxbot.robot_StopResponse;
            obj.reload(strObj);
        end
    end
end
