...
(cl:defmethod cl:initialize-instance :after ((m <robot_SetComm-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_SetComm-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name foxbot-srv:<robot_SetComm-request> is deprecated: use foxbot-srv:robot_SetComm-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <robot_SetComm-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_SetComm-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name foxbot-srv:<robot_SetComm-response> is deprecated: use foxbot-srv:robot_SetComm-response instead.")))
