...
(cl:defmethod cl:initialize-instance :after ((m <robot_Stop-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_Stop-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name foxbot-srv:<robot_Stop-request> is deprecated: use foxbot-srv:robot_Stop-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <robot_Stop-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_Stop-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name foxbot-srv:<robot_Stop-response> is deprecated: use foxbot-srv:robot_Stop-response instead.")))
