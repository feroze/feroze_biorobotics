...
;//! \htmlinclude robot_GetIK-request.msg.html

(cl:defclass <robot_GetIK-request> (roslisp-msg-protocol:ros-message)
  ((x
    :reader x
    :initarg :x
    :type cl:float
...
(cl:defclass robot_GetIK-request (<robot_GetIK-request>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <robot_GetIK-request>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'robot_GetIK-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name foxbot-srv:<robot_GetIK-request> is deprecated: use foxbot-srv:robot_GetIK-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <robot_GetIK-request>))
...
(cl:defmethod y-val ((m <robot_GetIK-request>))
...
(cl:defmethod z-val ((m <robot_GetIK-request>))
...
(cl:defmethod q0-val ((m <robot_GetIK-request>))
...
(cl:defmethod qx-val ((m <robot_GetIK-request>))
...
(cl:defmethod qy-val ((m <robot_GetIK-request>))
...
(cl:defmethod qz-val ((m <robot_GetIK-request>))
  ...
  (qz m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <robot_GetIK-request>) ostream)
  "Serializes a message object of type '<robot_GetIK-request>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <robot_GetIK-request>) istream)
  "Deserializes a message object of type '<robot_GetIK-request>"
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<robot_GetIK-request>)))
  "Returns string type for a service object of type '<robot_GetIK-request>"
  "foxbot/robot_GetIKRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robot_GetIK-request)))
  "Returns string type for a service object of type 'robot_GetIK-request"
  "foxbot/robot_GetIKRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<robot_GetIK-request>)))
  "Returns md5sum for a message object of type '<robot_GetIK-request>"
  "e8bf11be2a3edf791e341a71c52178e5")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'robot_GetIK-request)))
  "Returns md5sum for a message object of type 'robot_GetIK-request"
  "e8bf11be2a3edf791e341a71c52178e5")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<robot_GetIK-request>)))
  "Returns full string definition for message of type '<robot_GetIK-request>"
  (cl:format cl:nil "~%~%float64 x~%float64 y~%float64 z~%float64 q0~%float64 qx~%float64 qy~%float64 qz~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'robot_GetIK-request)))
  "Returns full string definition for message of type 'robot_GetIK-request"
  (cl:format cl:nil "~%~%float64 x~%float64 y~%float64 z~%float64 q0~%float64 qx~%float64 qy~%float64 qz~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <robot_GetIK-request>))
  (cl:+ 0
     8
     8
     8
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <robot_GetIK-request>))
  "Converts a ROS message object to a list"
  (cl:list 'robot_GetIK-request
    (cl:cons ':x (x msg))
    (cl:cons ':y (y msg))
    (cl:cons ':z (z msg))
    (cl:cons ':q0 (q0 msg))
...
;//! \htmlinclude robot_GetIK-response.msg.html

(cl:defclass <robot_GetIK-response> (roslisp-msg-protocol:ros-message)
  ((j1
    :reader j1
    :initarg :j1
    :type cl:float
...
(cl:defclass robot_GetIK-response (<robot_GetIK-response>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <robot_GetIK-response>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'robot_GetIK-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name foxbot-srv:<robot_GetIK-response> is deprecated: use foxbot-srv:robot_GetIK-response instead.")))

(cl:ensure-generic-function 'j1-val :lambda-list '(m))
(cl:defmethod j1-val ((m <robot_GetIK-response>))
...
(cl:defmethod j2-val ((m <robot_GetIK-response>))
...
(cl:defmethod j3-val ((m <robot_GetIK-response>))
...
(cl:defmethod j4-val ((m <robot_GetIK-response>))
...
(cl:defmethod j5-val ((m <robot_GetIK-response>))
...
(cl:defmethod j6-val ((m <robot_GetIK-response>))
...
(cl:defmethod ret-val ((m <robot_GetIK-response>))
...
(cl:defmethod msg-val ((m <robot_GetIK-response>))
  ...
  (msg m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <robot_GetIK-response>) ostream)
  "Serializes a message object of type '<robot_GetIK-response>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <robot_GetIK-response>) istream)
  "Deserializes a message object of type '<robot_GetIK-response>"
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<robot_GetIK-response>)))
  "Returns string type for a service object of type '<robot_GetIK-response>"
  "foxbot/robot_GetIKResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robot_GetIK-response)))
  "Returns string type for a service object of type 'robot_GetIK-response"
  "foxbot/robot_GetIKResponse")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<robot_GetIK-response>)))
  "Returns md5sum for a message object of type '<robot_GetIK-response>"
  "e8bf11be2a3edf791e341a71c52178e5")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'robot_GetIK-response)))
  "Returns md5sum for a message object of type 'robot_GetIK-response"
  "e8bf11be2a3edf791e341a71c52178e5")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<robot_GetIK-response>)))
  "Returns full string definition for message of type '<robot_GetIK-response>"
  (cl:format cl:nil "float64 j1~%float64 j2~%float64 j3~%float64 j4~%float64 j5~%float64 j6~%int64 ret~%string msg~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'robot_GetIK-response)))
  "Returns full string definition for message of type 'robot_GetIK-response"
  (cl:format cl:nil "float64 j1~%float64 j2~%float64 j3~%float64 j4~%float64 j5~%float64 j6~%int64 ret~%string msg~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <robot_GetIK-response>))
  (cl:+ 0
     8
     8
     8
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <robot_GetIK-response>))
  "Converts a ROS message object to a list"
  (cl:list 'robot_GetIK-response
    (cl:cons ':j1 (j1 msg))
    (cl:cons ':j2 (j2 msg))
    (cl:cons ':j3 (j3 msg))
    (cl:cons ':j4 (j4 msg))
...
(cl:defmethod roslisp-msg-protocol:service-request-type ((msg (cl:eql 'robot_GetIK)))
  'robot_GetIK-request)
(cl:defmethod roslisp-msg-protocol:service-response-type ((msg (cl:eql 'robot_GetIK)))
  'robot_GetIK-response)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robot_GetIK)))
  "Returns string type for a service object of type '<robot_GetIK>"
  "foxbot/robot_GetIK")