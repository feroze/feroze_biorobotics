...
(cl:defmethod cl:initialize-instance :after ((m <robot_Approach-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_Approach-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name foxbot-srv:<robot_Approach-request> is deprecated: use foxbot-srv:robot_Approach-request instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <robot_Approach-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader foxbot-srv:pose-val is deprecated.  Use foxbot-srv:pose instead.")
  (pose m))
...
(cl:defmethod cl:initialize-instance :after ((m <robot_Approach-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_Approach-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name foxbot-srv:<robot_Approach-response> is deprecated: use foxbot-srv:robot_Approach-response instead.")))
