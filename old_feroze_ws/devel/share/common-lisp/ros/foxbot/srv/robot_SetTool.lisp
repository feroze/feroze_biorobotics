...
(cl:defmethod cl:initialize-instance :after ((m <robot_SetTool-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_SetTool-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name foxbot-srv:<robot_SetTool-request> is deprecated: use foxbot-srv:robot_SetTool-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <robot_SetTool-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_SetTool-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name foxbot-srv:<robot_SetTool-response> is deprecated: use foxbot-srv:robot_SetTool-response instead.")))
