...
(cl:defmethod cl:initialize-instance :after ((m <robot_Ping-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_Ping-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name foxbot-srv:<robot_Ping-request> is deprecated: use foxbot-srv:robot_Ping-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <robot_Ping-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_Ping-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name foxbot-srv:<robot_Ping-response> is deprecated: use foxbot-srv:robot_Ping-response instead.")))
