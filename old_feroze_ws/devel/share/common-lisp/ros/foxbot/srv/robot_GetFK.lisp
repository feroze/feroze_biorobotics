...
;//! \htmlinclude robot_GetFK-request.msg.html

(cl:defclass <robot_GetFK-request> (roslisp-msg-protocol:ros-message)
  ((j1
    :reader j1
    :initarg :j1
    :type cl:float
...
(cl:defclass robot_GetFK-request (<robot_GetFK-request>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <robot_GetFK-request>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'robot_GetFK-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name foxbot-srv:<robot_GetFK-request> is deprecated: use foxbot-srv:robot_GetFK-request instead.")))

(cl:ensure-generic-function 'j1-val :lambda-list '(m))
(cl:defmethod j1-val ((m <robot_GetFK-request>))
...
(cl:defmethod j2-val ((m <robot_GetFK-request>))
...
(cl:defmethod j3-val ((m <robot_GetFK-request>))
...
(cl:defmethod j4-val ((m <robot_GetFK-request>))
...
(cl:defmethod j5-val ((m <robot_GetFK-request>))
...
(cl:defmethod j6-val ((m <robot_GetFK-request>))
  ...
  (j6 m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <robot_GetFK-request>) ostream)
  "Serializes a message object of type '<robot_GetFK-request>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <robot_GetFK-request>) istream)
  "Deserializes a message object of type '<robot_GetFK-request>"
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<robot_GetFK-request>)))
  "Returns string type for a service object of type '<robot_GetFK-request>"
  "foxbot/robot_GetFKRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robot_GetFK-request)))
  "Returns string type for a service object of type 'robot_GetFK-request"
  "foxbot/robot_GetFKRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<robot_GetFK-request>)))
  "Returns md5sum for a message object of type '<robot_GetFK-request>"
  "c6deda797d8a6e552534be5c1a9e2f8d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'robot_GetFK-request)))
  "Returns md5sum for a message object of type 'robot_GetFK-request"
  "c6deda797d8a6e552534be5c1a9e2f8d")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<robot_GetFK-request>)))
  "Returns full string definition for message of type '<robot_GetFK-request>"
  (cl:format cl:nil "~%~%float64 j1~%float64 j2~%float64 j3~%float64 j4~%float64 j5~%float64 j6~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'robot_GetFK-request)))
  "Returns full string definition for message of type 'robot_GetFK-request"
  (cl:format cl:nil "~%~%float64 j1~%float64 j2~%float64 j3~%float64 j4~%float64 j5~%float64 j6~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <robot_GetFK-request>))
  (cl:+ 0
     8
     8
     8
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <robot_GetFK-request>))
  "Converts a ROS message object to a list"
  (cl:list 'robot_GetFK-request
    (cl:cons ':j1 (j1 msg))
    (cl:cons ':j2 (j2 msg))
    (cl:cons ':j3 (j3 msg))
    (cl:cons ':j4 (j4 msg))
...
;//! \htmlinclude robot_GetFK-response.msg.html

(cl:defclass <robot_GetFK-response> (roslisp-msg-protocol:ros-message)
  ((x
    :reader x
    :initarg :x
    :type cl:float
...
(cl:defclass robot_GetFK-response (<robot_GetFK-response>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <robot_GetFK-response>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'robot_GetFK-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name foxbot-srv:<robot_GetFK-response> is deprecated: use foxbot-srv:robot_GetFK-response instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <robot_GetFK-response>))
...
(cl:defmethod y-val ((m <robot_GetFK-response>))
...
(cl:defmethod z-val ((m <robot_GetFK-response>))
...
(cl:defmethod q0-val ((m <robot_GetFK-response>))
...
(cl:defmethod qx-val ((m <robot_GetFK-response>))
...
(cl:defmethod qy-val ((m <robot_GetFK-response>))
...
(cl:defmethod qz-val ((m <robot_GetFK-response>))
...
(cl:defmethod ret-val ((m <robot_GetFK-response>))
...
(cl:defmethod msg-val ((m <robot_GetFK-response>))
  ...
  (msg m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <robot_GetFK-response>) ostream)
  "Serializes a message object of type '<robot_GetFK-response>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <robot_GetFK-response>) istream)
  "Deserializes a message object of type '<robot_GetFK-response>"
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<robot_GetFK-response>)))
  "Returns string type for a service object of type '<robot_GetFK-response>"
  "foxbot/robot_GetFKResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robot_GetFK-response)))
  "Returns string type for a service object of type 'robot_GetFK-response"
  "foxbot/robot_GetFKResponse")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<robot_GetFK-response>)))
  "Returns md5sum for a message object of type '<robot_GetFK-response>"
  "c6deda797d8a6e552534be5c1a9e2f8d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'robot_GetFK-response)))
  "Returns md5sum for a message object of type 'robot_GetFK-response"
  "c6deda797d8a6e552534be5c1a9e2f8d")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<robot_GetFK-response>)))
  "Returns full string definition for message of type '<robot_GetFK-response>"
  (cl:format cl:nil "~%float64 x~%float64 y~%float64 z~%float64 q0~%float64 qx~%float64 qy~%float64 qz~%~%int64 ret~%string msg~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'robot_GetFK-response)))
  "Returns full string definition for message of type 'robot_GetFK-response"
  (cl:format cl:nil "~%float64 x~%float64 y~%float64 z~%float64 q0~%float64 qx~%float64 qy~%float64 qz~%~%int64 ret~%string msg~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <robot_GetFK-response>))
  (cl:+ 0
     8
     8
     8
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <robot_GetFK-response>))
  "Converts a ROS message object to a list"
  (cl:list 'robot_GetFK-response
    (cl:cons ':x (x msg))
    (cl:cons ':y (y msg))
    (cl:cons ':z (z msg))
    (cl:cons ':q0 (q0 msg))
...
(cl:defmethod roslisp-msg-protocol:service-request-type ((msg (cl:eql 'robot_GetFK)))
  'robot_GetFK-request)
(cl:defmethod roslisp-msg-protocol:service-response-type ((msg (cl:eql 'robot_GetFK)))
  'robot_GetFK-response)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robot_GetFK)))
  "Returns string type for a service object of type '<robot_GetFK>"
  "foxbot/robot_GetFK")