classdef robot_SetToolResponse < robotics.ros.Message
    %robot_SetToolResponse MATLAB implementation of foxbot/robot_SetToolResponse
    ...
    properties (Constant)
        MessageType = 'foxbot/robot_SetToolResponse' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.foxbot.robot_SetToolResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.foxbot.robot_SetToolResponse;
            obj.reload(strObj);
        end
    end
end
