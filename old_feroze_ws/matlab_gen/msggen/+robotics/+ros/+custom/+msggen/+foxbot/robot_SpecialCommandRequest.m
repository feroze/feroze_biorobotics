classdef robot_SpecialCommandRequest < robotics.ros.Message
    %robot_SpecialCommandRequest MATLAB implementation of foxbot/robot_SpecialCommandRequest
    ...
    properties (Constant)
        MessageType = 'foxbot/robot_SpecialCommandRequest' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.foxbot.robot_SpecialCommandRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.foxbot.robot_SpecialCommandRequest;
            obj.reload(strObj);
        end
    end
end
