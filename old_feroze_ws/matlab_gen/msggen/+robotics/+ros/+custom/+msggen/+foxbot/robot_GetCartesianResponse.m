classdef robot_GetCartesianResponse < robotics.ros.Message
    %robot_GetCartesianResponse MATLAB implementation of foxbot/robot_GetCartesianResponse
    ...
    properties (Constant)
        MessageType = 'foxbot/robot_GetCartesianResponse' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = '43dc129ef42463a0f60c95d569d483e8' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Hidden)
        PropertyList = {'FrameId', 'Msg', 'Q0', 'Qx', 'Qy', 'Qz', 'Ret', 'X', 'Y', 'Z'} % List of non-constant message properties
        ROSPropertyList = {'frameId', 'msg', 'q0', 'qx', 'qy', 'qz', 'ret', 'x', 'y', 'z'} % List of non-constant ROS message properties
    end
    ...
    methods
        ...
        function frameid = get.FrameId(obj)
            ...
            frameid = typecast(int8(obj.JavaMessage.getFrameId), 'uint8');
        end
        
        function set.FrameId(obj, frameid)
            %set.FrameId Set the value for property FrameId
            validateattributes(frameid, {'numeric'}, {'nonempty', 'scalar'}, 'robot_GetCartesianResponse', 'frameid');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.foxbot.robot_GetCartesianResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.foxbot.robot_GetCartesianResponse;
            obj.reload(strObj);
        end
    end
end
