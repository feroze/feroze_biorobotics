classdef robot_SetVacuumResponse < robotics.ros.Message
    %robot_SetVacuumResponse MATLAB implementation of foxbot/robot_SetVacuumResponse
    ...
    properties (Constant)
        MessageType = 'foxbot/robot_SetVacuumResponse' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.foxbot.robot_SetVacuumResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.foxbot.robot_SetVacuumResponse;
            obj.reload(strObj);
        end
    end
end
