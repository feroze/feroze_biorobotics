classdef robot_SetTrackDistResponse < robotics.ros.Message
    %robot_SetTrackDistResponse MATLAB implementation of foxbot/robot_SetTrackDistResponse
    ...
    properties (Constant)
        MessageType = 'foxbot/robot_SetTrackDistResponse' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.foxbot.robot_SetTrackDistResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.foxbot.robot_SetTrackDistResponse;
            obj.reload(strObj);
        end
    end
end
