classdef robot_SetJointsRequest < robotics.ros.Message
    %robot_SetJointsRequest MATLAB implementation of foxbot/robot_SetJointsRequest
    ...
    properties (Constant)
        MessageType = 'foxbot/robot_SetJointsRequest' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.foxbot.robot_SetJointsRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.foxbot.robot_SetJointsRequest;
            obj.reload(strObj);
        end
    end
end
