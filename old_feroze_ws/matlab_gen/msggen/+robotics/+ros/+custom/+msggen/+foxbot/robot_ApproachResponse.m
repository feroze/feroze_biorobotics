classdef robot_ApproachResponse < robotics.ros.Message
    %robot_ApproachResponse MATLAB implementation of foxbot/robot_ApproachResponse
    ...
    properties (Constant)
        MessageType = 'foxbot/robot_ApproachResponse' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.foxbot.robot_ApproachResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.foxbot.robot_ApproachResponse;
            obj.reload(strObj);
        end
    end
end
