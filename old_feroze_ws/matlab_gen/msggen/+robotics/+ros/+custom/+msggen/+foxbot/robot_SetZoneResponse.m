classdef robot_SetZoneResponse < robotics.ros.Message
    %robot_SetZoneResponse MATLAB implementation of foxbot/robot_SetZoneResponse
    ...
    properties (Constant)
        MessageType = 'foxbot/robot_SetZoneResponse' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.foxbot.robot_SetZoneResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.foxbot.robot_SetZoneResponse;
            obj.reload(strObj);
        end
    end
end
