classdef robot_GetFKResponse < robotics.ros.Message
    %robot_GetFKResponse MATLAB implementation of foxbot/robot_GetFKResponse
    ...
    properties (Constant)
        MessageType = 'foxbot/robot_GetFKResponse' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.foxbot.robot_GetFKResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.foxbot.robot_GetFKResponse;
            obj.reload(strObj);
        end
    end
end
