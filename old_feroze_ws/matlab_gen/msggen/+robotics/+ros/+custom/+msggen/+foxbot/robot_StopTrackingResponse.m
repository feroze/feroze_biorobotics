classdef robot_StopTrackingResponse < robotics.ros.Message
    %robot_StopTrackingResponse MATLAB implementation of foxbot/robot_StopTrackingResponse
    ...
    properties (Constant)
        MessageType = 'foxbot/robot_StopTrackingResponse' % The ROS message type
    end
    ...
    methods
        function obj = robot_StopTrackingResponse(msg)
            %robot_StopTrackingResponse Construct the message object robot_StopTrackingResponse
        ...
        function set.Ret(obj, ret)
            ...
            validateattributes(ret, {'numeric'}, {'nonempty', 'scalar'}, 'robot_StopTrackingResponse', 'ret');
        ...
        function set.Msg(obj, msg)
            ...
            validateattributes(msg, {'char'}, {}, 'robot_StopTrackingResponse', 'msg');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.foxbot.robot_StopTrackingResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.foxbot.robot_StopTrackingResponse;
            obj.reload(strObj);
        end
    end
end
