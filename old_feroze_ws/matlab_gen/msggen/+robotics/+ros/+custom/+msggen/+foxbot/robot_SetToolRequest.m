classdef robot_SetToolRequest < robotics.ros.Message
    %robot_SetToolRequest MATLAB implementation of foxbot/robot_SetToolRequest
    ...
    properties (Constant)
        MessageType = 'foxbot/robot_SetToolRequest' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.foxbot.robot_SetToolRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.foxbot.robot_SetToolRequest;
            obj.reload(strObj);
        end
    end
end
