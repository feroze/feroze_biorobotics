classdef robot_SetCommResponse < robotics.ros.Message
    %robot_SetCommResponse MATLAB implementation of foxbot/robot_SetCommResponse
    ...
    properties (Constant)
        MessageType = 'foxbot/robot_SetCommResponse' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.foxbot.robot_SetCommResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.foxbot.robot_SetCommResponse;
            obj.reload(strObj);
        end
    end
end
