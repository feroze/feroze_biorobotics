classdef robot_GetJointsResponse < robotics.ros.Message
    %robot_GetJointsResponse MATLAB implementation of foxbot/robot_GetJointsResponse
    ...
    properties (Constant)
        MessageType = 'foxbot/robot_GetJointsResponse' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.foxbot.robot_GetJointsResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.foxbot.robot_GetJointsResponse;
            obj.reload(strObj);
        end
    end
end
