classdef robot_SetSpeedResponse < robotics.ros.Message
    %robot_SetSpeedResponse MATLAB implementation of foxbot/robot_SetSpeedResponse
    ...
    properties (Constant)
        MessageType = 'foxbot/robot_SetSpeedResponse' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.foxbot.robot_SetSpeedResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.foxbot.robot_SetSpeedResponse;
            obj.reload(strObj);
        end
    end
end
