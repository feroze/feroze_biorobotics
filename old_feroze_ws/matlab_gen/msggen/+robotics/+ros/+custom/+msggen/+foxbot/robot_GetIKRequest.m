classdef robot_GetIKRequest < robotics.ros.Message
    %robot_GetIKRequest MATLAB implementation of foxbot/robot_GetIKRequest
    ...
    properties (Constant)
        MessageType = 'foxbot/robot_GetIKRequest' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.foxbot.robot_GetIKRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.foxbot.robot_GetIKRequest;
            obj.reload(strObj);
        end
    end
end
