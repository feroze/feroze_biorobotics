classdef robot_JogCartesianResponse < robotics.ros.Message
    %robot_JogCartesianResponse MATLAB implementation of foxbot/robot_JogCartesianResponse
    ...
    properties (Constant)
        MessageType = 'foxbot/robot_JogCartesianResponse' % The ROS message type
    end
    ...
    methods
        function obj = robot_JogCartesianResponse(msg)
            %robot_JogCartesianResponse Construct the message object robot_JogCartesianResponse
        ...
        function set.Ret(obj, ret)
            ...
            validateattributes(ret, {'numeric'}, {'nonempty', 'scalar'}, 'robot_JogCartesianResponse', 'ret');
        ...
        function set.Msg(obj, msg)
            ...
            validateattributes(msg, {'char'}, {}, 'robot_JogCartesianResponse', 'msg');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.foxbot.robot_JogCartesianResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.foxbot.robot_JogCartesianResponse;
            obj.reload(strObj);
        end
    end
end
